...
wget --no-check-certificate -qO- /etc/systemd/system/ping0.service https://raw.githubusercontent.com/uselibrary/Ping0Monitor/main/ping0.service > /etc/systemd/system/ping0.service
